...
const LANGUAGES = {
    ...
    "ja": {
        ...
        texts: {
            ...
            "counter-unit": "回",
            "counter-button": "だだだ~!",
            "credits-gif": "感謝: DuongNhanAC さんが提供してくれたクレーのGIF画像",
            "footer-repository-text-2": "可莉哒哒哒的仓库",
    ...
    "en": {
        ...
        texts: {
            ...
            "credits-gif": "Acknowledgment: GIF images of Klee provided by DuongNhanAC.",
            "footer-repository-text-2": "可莉哒哒哒的仓库",
